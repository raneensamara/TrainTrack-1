...
Route::get('/traintrack/popup/fallback', fn() => view('popup'))->name('traintrack.popup');
Route::get('/traintrack/fallback/improve', fn() => view('fallbackimprove'))->name('traintrack.fallback.improve');
Route::get('/traintrack/popup/nomatch',fn() => view('nomatch'))->name('traintrack.nomatch');
